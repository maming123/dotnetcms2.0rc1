...
namespace Common
{
    ...
    public class MultipartForm
    {
        ...
        /// 保存日志文件
        /// </summary>
        /// <param name="num">登录次数</param>
        /// <param name="userNum">传入的用户编号</param>
        /// <param name="title">日志标题</param>
        /// <param name="content">日志描述</param>
        public static void SaveLogFiles(int num, string userNum, string title, string content)
        {
            ...
            try
            {
                FileName = HttpContext.Current.Server.MapPath("~/Logs/User-" + num + "-") + FileName + "-" + StringPlus.MD5(FileName) + "-s.log";
                ...
                sw.WriteLine("IP                 :" + Common.Computer.GetIP() + "");
