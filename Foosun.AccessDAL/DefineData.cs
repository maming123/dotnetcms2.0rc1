    ...
    public partial class DefineData :DbBase, IDefineData
    {
        ...
        public bool Exists(string defineInfoId)
        {
            ...
            OleDbParameter[] parameters = {
					new OleDbParameter("@defineInfoId", OleDbType.VarWChar,12)			
                                        };
        ...
        public bool Add(Foosun.Model.DefineData model)
        {
            ...
            OleDbParameter[] parameters = {
					new OleDbParameter("@defineInfoId", OleDbType.VarWChar,12),
					new OleDbParameter("@defineCname", OleDbType.VarWChar,50),
					new OleDbParameter("@defineColumns", OleDbType.VarWChar,50),
					new OleDbParameter("@defineType", OleDbType.Integer,4),
					new OleDbParameter("@IsNull", OleDbType.TinyInt,1),
					new OleDbParameter("@defineValue", OleDbType.VarWChar),
					new OleDbParameter("@defineExpr", OleDbType.VarWChar,200),
					new OleDbParameter("@definedvalue", OleDbType.VarWChar,200),
        ...
        public Foosun.Model.DefineData GetModel(int id)
        {
            ...
            strSql.Append(" where id=@id ");
            OleDbParameter[] parameters = {
					new OleDbParameter("@defineInfoId", OleDbType.Integer)			};
            parameters[0].Value = id;
        ...
        {
            OleDbParameter param = new OleDbParameter("@defineColumns", ename);
        ...
        {
            OleDbParameter param = new OleDbParameter("@DefineCname", cname);
