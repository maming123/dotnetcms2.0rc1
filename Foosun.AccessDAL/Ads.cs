...
namespace Foosun.AccessDAL
{
    public class Ads : DbBase, IAds
    {
        ...
        public DataTable list(Foosun.Model.AdsListInfo ali)
        {
            ...
            switch (ali.type)
            {
                case "Ads":
                    switch (ali.showAdsType)
                    {
                        case "showadstype":
                            ...
                            str_Sql = "Select " + Pre + "ads.AdID," + Pre + "ads.adName," + Pre + "ads.adType," + Pre + "ads.creatTime," + Pre + "ads.CusID," + Pre + "ads.isLock,Cname From " + Pre + "ads left join " + Pre + "ads_class on  fs_ads.ClassID=fs_ads_class.AcID Where" +
                        ...
                        case "search":
                            ...
                            {
                                case "adsname":
                                    str_Sql = "Select " + Pre + "ads.AdID," + Pre + "ads.adName," + Pre + "ads.adType," + Pre + "ads.creatTime," + Pre + "ads.CusID," + Pre + "ads.isLock,Cname From " + Pre + "ads left join " + Pre + "ads_class on  fs_ads.ClassID=fs_ads_class.AcID " +
                ...
                case "Stat":
                    ...
                    break;
                case "ClassName":
                    str_Sql = "select " + Pre + "ads.AdID," + Pre + "ads.adName," + Pre + "ads.adType," + Pre + "ads.creatTime," + Pre + "ads.CusID," + Pre + "ads.isLock,Cname from " + Pre + "ads left join " + Pre + "ads_class on  fs_ads.ClassID=fs_ads_class.AcID where Cname like '%" + ali.SearchKey + "%'";
                    break;
            }
        ...
        public void DelPAds(string id)
        {
            ...
            try
            {
                string Sql = "Delete From " + Pre + "adstxt Where AdID In (" + id + ")";
                DbHelper.ExecuteNonQuery(tran, CommandType.Text, Sql, null);
                string Sql1 = "Delete From " + Pre + "ads_stat Where AdID In (" + id + ")";
                DbHelper.ExecuteNonQuery(tran, CommandType.Text, Sql1, null);
                string Sql2 = "Delete From " + Pre + "ads Where SiteID='" + SiteID + "' And AdID In(" + id + ")";
                DbHelper.ExecuteNonQuery(tran, CommandType.Text, Sql2, null);
                tran.Commit();
                Conn.Close();
            }
        ...
        {
            string Sql = "Delete From " + Pre + "adstxt Where AdID In (Select AdID From " + Pre + "ads Where ClassID In(Select " +
                             "AcID From " + Pre + "ads_class Where SiteID='" + SiteID + "'))";
            DbHelper.ExecuteNonQuery(CommandType.Text, Sql, null);
            string Sql1 = "Delete From " + Pre + "ads_stat Where AdID In (Select AdID From " + Pre + "ads Where ClassID In(Select " +
                              "AcID From " + Pre + "ads_class Where SiteID='" + SiteID + "'))";
            DbHelper.ExecuteNonQuery(CommandType.Text, Sql1, null);
            string Sql2 = "Delete From " + Pre + "ads Where ClassID In(Select " +
                              "AcID From " + Pre + "ads_class Where SiteID='" + SiteID + "')";
            DbHelper.ExecuteNonQuery(CommandType.Text, Sql2, null);

            string Sql3 = "Delete From " + Pre + "ads_class Where SiteID='" + SiteID + "'";
            DbHelper.ExecuteNonQuery(CommandType.Text, Sql3, null);
        ...
        public void DelPAdsClass(string classid)
        {
            Recyle rc = new Recyle();
            string idstr = rc.GetIDStr(classid, "AcID,ParentID", "ads_class");
            string Sql = "Delete From " + Pre + "adstxt Where AdID In (Select AdID From " + Pre + "ads Where ClassID In(" + idstr + "))";
            DbHelper.ExecuteNonQuery(CommandType.Text, Sql, null);
            string Sql1 = "Delete From " + Pre + "ads_stat Where AdID In (Select AdID From " + Pre + "ads Where ClassID In(" + idstr + "))";
            DbHelper.ExecuteNonQuery(CommandType.Text, Sql1, null);
            string Sql2 = "Delete From " + Pre + "ads Where ClassID In(" + idstr + ")";
            DbHelper.ExecuteNonQuery(CommandType.Text, Sql2, null);
            string Sql3 = "Delete From " + Pre + "ads_class Where SiteID='" + SiteID + "' And AcID In(" + idstr + ")";
            DbHelper.ExecuteNonQuery(CommandType.Text, Sql3, null);
        }
