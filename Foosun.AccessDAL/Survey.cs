...
namespace Foosun.AccessDAL
{
    public class Survey : DbBase, ISurvey
    {
        ...
        {
            string Sql = "Select a.VID,a.ClassName,b.TID,b.Title From " + Pre + "vote_Class as a, " + Pre + "vote_Title as b where a.VID=b.VID and a.SiteID='" + SiteID + "' and b.SiteID='" + SiteID + "'";
            return DbHelper.ExecuteTable(CommandType.Text, Sql, null);
        }
