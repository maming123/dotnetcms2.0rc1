    ...
    public class UserMisc : DbBase, IUserMisc
    {
        ...
        public void InsertManageMenu(Foosun.Model.UserInfo7 model)
        {
            ...
            OleDbParameter[] parameters = {
					new OleDbParameter("@am_ClassID", OleDbType.VarChar,12),
					new OleDbParameter("@am_Name", OleDbType.VarChar,20),
					new OleDbParameter("@am_FilePath", OleDbType.VarChar,200),
					new OleDbParameter("@am_ChildrenID", OleDbType.VarChar),
					...
					new OleDbParameter("@userNum", OleDbType.VarChar,15),
					new OleDbParameter("@popCode", OleDbType.VarChar,50),
					new OleDbParameter("@imgPath", OleDbType.VarChar,200),
					new OleDbParameter("@imgwidth", OleDbType.VarChar,10),
					new OleDbParameter("@imgheight", OleDbType.VarChar,10)};
        ...
        private OleDbParameter[] InsertManageMenuParameters2(Foosun.Model.UserInfo7 uc1)
        {
            ...
            param[0] = new OleDbParameter("@am_Name", OleDbType.VarChar, 20);
            ...
            param[3] = new OleDbParameter("@popCode", OleDbType.VarChar, 50);
        ...
        private OleDbParameter[] InsertQMenuParameters(Foosun.Model.UserInfo8 uc1)
        {
            ...
            param[0] = new OleDbParameter("@QmID", OleDbType.VarChar, 12);
            param[0].Value = uc1.QmID;
            param[1] = new OleDbParameter("@qName", OleDbType.VarChar, 50);
            param[1].Value = uc1.qName;
            param[2] = new OleDbParameter("@FilePath", OleDbType.VarChar, 200);
            param[2].Value = uc1.FilePath;
            param[3] = new OleDbParameter("@Ismanage", OleDbType.TinyInt, 1);
            param[3].Value = uc1.Ismanage;
            param[4] = new OleDbParameter("@OrderID", OleDbType.Integer, 4);
            param[4].Value = uc1.OrderID;
            param[5] = new OleDbParameter("@usernum", OleDbType.VarChar, 15);
            param[5].Value = uc1.usernum;
            param[6] = new OleDbParameter("@SiteID", OleDbType.VarChar, 12);
        ...
        {
            OleDbParameter[] param = new OleDbParameter[4];
            param[0] = new OleDbParameter("@qName", OleDbType.VarChar, 50);
            param[0].Value = uc1.qName;
            param[1] = new OleDbParameter("@FilePath", OleDbType.VarChar, 200);
        ...
        public void UpdateUserSafe(int Uid, string PassQuestion, string PassKey, string password)
        {
            ...
            param[0] = new OleDbParameter("@PassQuestion", OleDbType.VarChar, 20);
            param[0].Value = PassQuestion;
            param[1] = new OleDbParameter("@PassKey", OleDbType.VarChar, 20);
            param[1].Value = Common.Input.MD5(PassKey);
            param[2] = new OleDbParameter("@password", OleDbType.VarChar, 32);
        ...
        private OleDbParameter[] GetUserInfoParameters(Foosun.Model.UserInfo uc)
        {
            ...
            param[0] = new OleDbParameter("@NickName", OleDbType.VarChar, 12);
            param[0].Value = uc.NickName;
            param[1] = new OleDbParameter("@RealName", OleDbType.VarChar, 20);
            param[1].Value = uc.RealName;
            param[2] = new OleDbParameter("@sex", OleDbType.TinyInt, 1);
            param[2].Value = uc.sex;
            param[3] = new OleDbParameter("@birthday", OleDbType.Date, 8);
            param[3].Value = uc.birthday;
            param[4] = new OleDbParameter("@Userinfo", OleDbType.VarChar);
            param[4].Value = uc.Userinfo;
            param[5] = new OleDbParameter("@UserFace", OleDbType.VarChar, 220);
            param[5].Value = uc.UserFace;
            param[6] = new OleDbParameter("@userFacesize", OleDbType.VarChar, 8);
            param[6].Value = uc.userFacesize;
            param[7] = new OleDbParameter("@marriage", OleDbType.TinyInt, 1);
            param[7].Value = uc.marriage;
            param[8] = new OleDbParameter("@isopen", OleDbType.TinyInt, 1);
            param[8].Value = uc.isopen;
            param[9] = new OleDbParameter("@UserGroupNumber", OleDbType.VarChar, 12);
            param[9].Value = uc.UserGroupNumber;
            param[10] = new OleDbParameter("@email", OleDbType.VarChar, 220);
        ...
        private OleDbParameter[] GetUserInfoParameters1(Foosun.Model.UserInfo1 uc1)
        {
            ...
            param[0] = new OleDbParameter("@Nation", OleDbType.VarChar, 12);
            param[0].Value = uc1.Nation;
            param[1] = new OleDbParameter("@nativeplace", OleDbType.VarChar, 20);
            param[1].Value = uc1.nativeplace;
            param[2] = new OleDbParameter("@character", OleDbType.VarChar);
            param[2].Value = uc1.character;
            param[3] = new OleDbParameter("@UserFan", OleDbType.VarChar);
            param[3].Value = uc1.UserFan;
            param[4] = new OleDbParameter("@orgSch", OleDbType.VarChar, 10);
            param[4].Value = uc1.orgSch;
            param[5] = new OleDbParameter("@job", OleDbType.VarChar, 30);
            param[5].Value = uc1.job;
            param[6] = new OleDbParameter("@education", OleDbType.VarChar, 20);
            param[6].Value = uc1.education;
            param[7] = new OleDbParameter("@Lastschool", OleDbType.VarChar, 80);
            param[7].Value = uc1.Lastschool;
            param[8] = new OleDbParameter("@UserNum", OleDbType.VarChar, 15);
        ...
        private OleDbParameter[] GetUserInfoContactParameters1(Foosun.Model.UserInfo2 uc1)
        {
            ...
            param[0] = new OleDbParameter("@province", OleDbType.VarChar, 20);
            param[0].Value = uc1.province;
            param[1] = new OleDbParameter("@City", OleDbType.VarChar, 20);
            param[1].Value = uc1.City;
            param[2] = new OleDbParameter("@Address", OleDbType.VarChar, 50);
            param[2].Value = uc1.Address;
            param[3] = new OleDbParameter("@Postcode", OleDbType.VarChar, 10);
            param[3].Value = uc1.Postcode;
            param[4] = new OleDbParameter("@FaTel", OleDbType.VarChar, 30);
            param[4].Value = uc1.FaTel;
            param[5] = new OleDbParameter("@WorkTel", OleDbType.VarChar, 30);
            param[5].Value = uc1.WorkTel;
            param[6] = new OleDbParameter("@Fax", OleDbType.VarChar, 30);
            param[6].Value = uc1.Fax;
            param[7] = new OleDbParameter("@QQ", OleDbType.VarChar, 30);
            param[7].Value = uc1.QQ;
            param[8] = new OleDbParameter("@MSN", OleDbType.VarChar, 150);
            param[8].Value = uc1.MSN;
            param[9] = new OleDbParameter("@UserNum", OleDbType.VarChar, 15);
        ...
        private OleDbParameter[] GetUserInfoBaseStatParameters1(Foosun.Model.UserInfo3 uc1)
        {
            ...
            param[0] = new OleDbParameter("@UserGroupNumber", OleDbType.VarChar, 12);
            param[0].Value = uc1.UserGroupNumber;
            param[1] = new OleDbParameter("@islock", OleDbType.TinyInt, 1);
            param[1].Value = uc1.islock;
            param[2] = new OleDbParameter("@isadmin", OleDbType.TinyInt, 1);
            param[2].Value = uc1.isadmin;
            param[3] = new OleDbParameter("@CertType", OleDbType.VarChar, 15);
            param[3].Value = uc1.CertType;
            param[4] = new OleDbParameter("@CertNumber", OleDbType.VarChar, 20);
            ...
            param[15] = new OleDbParameter("@lastIP", OleDbType.VarChar, 16);
            param[15].Value = uc1.lastIP;
            param[16] = new OleDbParameter("@SiteID", OleDbType.VarChar, 12);
        ...
        private OleDbParameter[] InsertGroupParameters(Foosun.Model.UserInfo4 uc1)
        {
            ...
            param[0] = new OleDbParameter("@SiteID", OleDbType.VarChar, 12);
            param[0].Value = uc1.SiteID;
            param[1] = new OleDbParameter("@GroupNumber", OleDbType.VarChar, 12);
            param[1].Value = uc1.GroupNumber;
            param[2] = new OleDbParameter("@GroupName", OleDbType.VarChar, 50);
            ...
            param[14] = new OleDbParameter("@DicussTF", OleDbType.TinyInt, 1);
            param[14].Value = uc1.DicussTF;
            param[15] = new OleDbParameter("@PostTitle", OleDbType.TinyInt, 1);
            param[15].Value = uc1.PostTitle;
            param[16] = new OleDbParameter("@ReadUser", OleDbType.TinyInt, 1);
            param[16].Value = uc1.ReadUser;
            param[17] = new OleDbParameter("@MessageNum", OleDbType.Integer, 4);
            param[17].Value = uc1.MessageNum;
            param[18] = new OleDbParameter("@MessageGroupNum", OleDbType.VarChar, 15);
            param[18].Value = uc1.MessageGroupNum;
            param[19] = new OleDbParameter("@IsCert", OleDbType.TinyInt, 1);
            param[19].Value = uc1.IsCert;
            param[20] = new OleDbParameter("@CharTF", OleDbType.TinyInt, 1);
            param[20].Value = uc1.CharTF;
            param[21] = new OleDbParameter("@CharHTML", OleDbType.TinyInt, 1);
            ...
            param[24] = new OleDbParameter("@PostTitleHTML", OleDbType.TinyInt, 1);
            param[24].Value = uc1.PostTitleHTML;
            param[25] = new OleDbParameter("@DelSelfTitle", OleDbType.TinyInt, 1);
            param[25].Value = uc1.DelSelfTitle;
            param[26] = new OleDbParameter("@DelOTitle", OleDbType.TinyInt, 1);
            param[26].Value = uc1.DelOTitle;
            param[27] = new OleDbParameter("@EditSelfTitle", OleDbType.TinyInt, 1);
            param[27].Value = uc1.EditSelfTitle;
            param[28] = new OleDbParameter("@EditOtitle", OleDbType.TinyInt, 1);
            param[28].Value = uc1.EditOtitle;
            param[29] = new OleDbParameter("@ReadTitle", OleDbType.TinyInt, 1);
            param[29].Value = uc1.ReadTitle;
            param[30] = new OleDbParameter("@MoveSelfTitle", OleDbType.TinyInt, 1);
            param[30].Value = uc1.MoveSelfTitle;
            param[31] = new OleDbParameter("@MoveOTitle", OleDbType.TinyInt, 1);
            param[31].Value = uc1.MoveOTitle;
            param[32] = new OleDbParameter("@TopTitle", OleDbType.TinyInt, 1);
            param[32].Value = uc1.TopTitle;
            param[33] = new OleDbParameter("@GoodTitle", OleDbType.TinyInt, 1);
            param[33].Value = uc1.GoodTitle;
            param[34] = new OleDbParameter("@LockUser", OleDbType.TinyInt, 1);
            param[34].Value = uc1.LockUser;

            param[35] = new OleDbParameter("@UserFlag", OleDbType.VarChar, 100);
            param[35].Value = uc1.UserFlag;
            param[36] = new OleDbParameter("@CheckTtile", OleDbType.TinyInt, 1);
            param[36].Value = uc1.CheckTtile;
            param[37] = new OleDbParameter("@IPTF", OleDbType.TinyInt, 1);
            param[37].Value = uc1.IPTF;
            param[38] = new OleDbParameter("@EncUser", OleDbType.TinyInt, 1);
            param[38].Value = uc1.EncUser;
            param[39] = new OleDbParameter("@OCTF", OleDbType.TinyInt, 1);
            param[39].Value = uc1.OCTF;
            param[40] = new OleDbParameter("@StyleTF", OleDbType.TinyInt, 1);
            param[40].Value = uc1.StyleTF;
            param[41] = new OleDbParameter("@UpfaceSize", OleDbType.Integer, 4);
            param[41].Value = uc1.UpfaceSize;


            param[42] = new OleDbParameter("@GIChange", OleDbType.VarChar, 10);
            param[42].Value = uc1.GIChange;
            param[43] = new OleDbParameter("@GTChageRate", OleDbType.VarChar, 30);
            param[43].Value = uc1.GTChageRate;
            param[44] = new OleDbParameter("@LoginPoint", OleDbType.VarChar, 20);
            param[44].Value = uc1.LoginPoint;
            param[45] = new OleDbParameter("@RegPoint", OleDbType.VarChar, 20);
            param[45].Value = uc1.RegPoint;
            param[46] = new OleDbParameter("@GroupTF", OleDbType.TinyInt, 1);
            ...
            param[51] = new OleDbParameter("@Discount", OleDbType.Integer, 8);
        ...
        private OleDbParameter[] updateGroupEditParameters(Foosun.Model.UserInfo4 uc1)
        {
            ...
            param[48] = new OleDbParameter("@GroupPerNum", OleDbType.Integer, 4);
            param[48].Value = uc1.GroupPerNum;
            param[49] = new OleDbParameter("@Discount", OleDbType.Integer, 8);
        ...
        private OleDbParameter[] GetAnnounceParameters(Foosun.Model.UserInfo5 uc1)
        {
            ...
            param[1] = new OleDbParameter("@Title", OleDbType.VarChar, 50);
            ...
            param[4] = new OleDbParameter("@GroupNumber", OleDbType.VarChar, 12);
            param[4].Value = uc1.GroupNumber;
            param[5] = new OleDbParameter("@getPoint", OleDbType.VarChar, 50);
            param[5].Value = uc1.getPoint;
            param[6] = new OleDbParameter("@SiteId", OleDbType.VarChar, 12);
            param[6].Value = uc1.SiteId;
            param[7] = new OleDbParameter("@isLock", OleDbType.TinyInt, 1);
        ...
        private OleDbParameter[] UpdateAnnounceParameters(Foosun.Model.UserInfo5 uc1)
        {
            ...
            param[0] = new OleDbParameter("@Title", OleDbType.VarChar, 50);
            param[0].Value = uc1.Title;
            param[1] = new OleDbParameter("@content", OleDbType.VarChar);
            param[1].Value = uc1.content;
            param[2] = new OleDbParameter("@GroupNumber", OleDbType.VarChar, 12);
            param[2].Value = uc1.GroupNumber;
            param[3] = new OleDbParameter("@getPoint", OleDbType.VarChar, 50);
        ...
        private OleDbParameter[] insertCardRParameters(Foosun.Model.IDCARD uc1)
        {
            ...
            param[0] = new OleDbParameter("@CaID", OleDbType.VarChar, 12);
            param[0].Value = uc1.CaID;
            param[1] = new OleDbParameter("@CardNumber", OleDbType.VarChar, 30);
            param[1].Value = uc1.CardNumber;
            param[2] = new OleDbParameter("@CardPassWord", OleDbType.VarChar, 150);
            ...
            param[6] = new OleDbParameter("@isBuy", OleDbType.TinyInt, 1);
            param[6].Value = uc1.isBuy;
            param[7] = new OleDbParameter("@isUse", OleDbType.TinyInt, 1);
            param[7].Value = uc1.isUse;
            param[8] = new OleDbParameter("@isLock", OleDbType.TinyInt, 1);
            param[8].Value = uc1.isLock;

            param[9] = new OleDbParameter("@UserNum", OleDbType.VarChar, 15);
            param[9].Value = uc1.UserNum;
            param[10] = new OleDbParameter("@siteID", OleDbType.VarChar, 12);
        ...
        {
            OleDbParameter[] param = new OleDbParameter[8];
            param[0] = new OleDbParameter("@CardPassWord", OleDbType.VarChar, 150);
            ...
            param[3] = new OleDbParameter("@isBuy", OleDbType.TinyInt, 1);
            param[3].Value = uc1.isBuy;
            param[4] = new OleDbParameter("@isUse", OleDbType.TinyInt, 1);
            param[4].Value = uc1.isUse;
            param[5] = new OleDbParameter("@isLock", OleDbType.TinyInt, 1);
        ...
        {
            OleDbParameter[] param = new OleDbParameter[9];
            param[0] = new OleDbParameter("@o_userName", OleDbType.VarChar, 100);
            param[0].Value = uc1.O_userName;
            param[1] = new OleDbParameter("@o_key", OleDbType.VarChar, 128);
            param[1].Value = uc1.O_key;
            param[2] = new OleDbParameter("@o_sendurl", OleDbType.VarChar, 220);
            param[2].Value = uc1.O_sendurl;
            param[3] = new OleDbParameter("@o_returnurl", OleDbType.VarChar, 220);
            param[3].Value = uc1.O_returnurl;
            param[4] = new OleDbParameter("@o_md5", OleDbType.VarChar, 128);
            param[4].Value = uc1.O_md5;
            param[5] = new OleDbParameter("@o_other1", OleDbType.VarChar, 220);
            param[5].Value = uc1.O_other1;
            param[6] = new OleDbParameter("@o_other2", OleDbType.VarChar, 220);
            param[6].Value = uc1.O_other2;
            param[7] = new OleDbParameter("@o_other3", OleDbType.VarChar, 220);
            param[7].Value = uc1.O_other3;
            param[8] = new OleDbParameter("@Id", OleDbType.VarChar, 128);
            param[8].Value = uc1.Id;
            param[8] = new OleDbParameter("@onpayType", OleDbType.TinyInt, 1);
