...
namespace Foosun.SQLServerDAL
{
    public class Label : DbBase, ILabel
    {
        ...
        {
            string str_Sql = "Select ClassID,ClassName From " + Pre + "sys_LabelClass Where isRecyle=0 And ClassID!='99999999' and ClassID!='88888888' and SiteID ='" + Foosun.Global.Current.SiteID + "' order by id desc";
            DataTable dt = DbHelper.ExecuteTable(CommandType.Text, str_Sql, null);
            return dt;
        }
        ...
        {
            string str_Sql = "Select LabelName,StyleContent,LabelSQL From " + Pre + "sys_LabelFree Where SiteID='" + Foosun.Global.Current.SiteID + "' Order By CreatTime Desc,id desc";
            DataTable dt = DbHelper.ExecuteTable(CommandType.Text, str_Sql, null);
            return dt;
        }
        ...
        private SqlParameter[] GetLabelClassParameters(Foosun.Model.LabelClassInfo lbcc)
        {
        ...
        private SqlParameter[] GetLabelParameters(Foosun.Model.LabelInfo lbc)
        {
