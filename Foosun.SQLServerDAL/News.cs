...
namespace Foosun.SQLServerDAL
{
    ...
    public partial class News : DbBase, INews
    {
        ...
        public void Add(Foosun.Model.News model)
        {
            ...
            SqlParameter[] parameters = {
			            new SqlParameter("@CommLinkTF", SqlDbType.TinyInt,1) ,            
                        new SqlParameter("@SubNewsTF", SqlDbType.TinyInt,1) ,            
                        new SqlParameter("@URLaddress", SqlDbType.NVarChar,200) ,            
                        new SqlParameter("@PicURL", SqlDbType.NVarChar,200) ,            
                        new SqlParameter("@SPicURL", SqlDbType.NVarChar,200) ,            
                        new SqlParameter("@ClassID", SqlDbType.NVarChar,12) ,            
                        new SqlParameter("@SpecialID", SqlDbType.NVarChar,200) ,            
                        new SqlParameter("@Author", SqlDbType.NVarChar,100) ,            
                        new SqlParameter("@Souce", SqlDbType.NVarChar,100) ,            
                        new SqlParameter("@Tags", SqlDbType.NVarChar,100) ,            
                        new SqlParameter("@NewsID", SqlDbType.NVarChar,12) ,            
                        new SqlParameter("@NewsProperty", SqlDbType.NVarChar,30) ,            
                        new SqlParameter("@NewsPicTopline", SqlDbType.TinyInt,1) ,            
                        ...
                        new SqlParameter("@naviContent", SqlDbType.NVarChar,255) ,            
                        ...
                        new SqlParameter("@isDelPoint", SqlDbType.TinyInt,1) ,            
                        new SqlParameter("@Gpoint", SqlDbType.Int,4) ,            
                        new SqlParameter("@iPoint", SqlDbType.Int,4) ,            
                        new SqlParameter("@GroupNumber", SqlDbType.NText) ,            
                        new SqlParameter("@ContentPicTF", SqlDbType.TinyInt,1) ,            
                        new SqlParameter("@ContentPicURL", SqlDbType.NVarChar,200) ,            
                        new SqlParameter("@ContentPicSize", SqlDbType.NVarChar,10) ,            
                        new SqlParameter("@OrderID", SqlDbType.TinyInt,1) ,            
                        new SqlParameter("@CommTF", SqlDbType.TinyInt,1) ,            
                        new SqlParameter("@DiscussTF", SqlDbType.TinyInt,1) ,            
                        new SqlParameter("@TopNum", SqlDbType.Int,4) ,            
                        new SqlParameter("@VoteTF", SqlDbType.TinyInt,1) ,            
                        new SqlParameter("@CheckStat", SqlDbType.NVarChar,10) ,            
                        ...
                        new SqlParameter("@DefineID", SqlDbType.TinyInt,1) ,            
                        new SqlParameter("@NewsTitle", SqlDbType.NVarChar,100) ,            
                        new SqlParameter("@isVoteTF", SqlDbType.TinyInt,1) ,            
                        new SqlParameter("@Editor", SqlDbType.NVarChar,18) ,            
                        new SqlParameter("@isHtml", SqlDbType.TinyInt,1) ,            
                        new SqlParameter("@isConstr", SqlDbType.TinyInt,1) ,            
                        new SqlParameter("@isFiles", SqlDbType.TinyInt,1) ,            
                        new SqlParameter("@vURL", SqlDbType.NVarChar,200) ,            
                        new SqlParameter("@sNewsTitle", SqlDbType.NVarChar,100) ,            
                        new SqlParameter("@TitleColor", SqlDbType.NVarChar,10) ,            
                        new SqlParameter("@TitleITF", SqlDbType.TinyInt,1) ,            
                        new SqlParameter("@TitleBTF", SqlDbType.TinyInt,1)             
        ...
        public void Copy_news(string ClassID, string sOrgNews, string NewsID, string FileName)
        {
            ...
            Foosun.SQLServerDAL.NewsClass sNewclass = new NewsClass();
        ...
        public DataTable GetPage(string SpecialID, string Editor, string ClassID, string sKeywrd, string DdlKwdType, string sChooses, string SiteID, int PageIndex, int PageSize, out int RecordCount, out int PageCount)
        {
            ...
            sqlParams[0] = new SqlParameter("keywords", sKeywrds);
            if (sKeywrds != "" && sKeywrds != null)
            {
                switch (DdlKwdType)
                {
                    case "content":
                        sFilter += " and Content like @keywords";
                        break;
                    case "author":
                        sFilter += " and Author like @keywords";
                        break;
                    case "editor":
                        sFilter += " and NewsTitle like @keywords";
                        break;
                    default:
                        sFilter += " and NewsTitle like @keywords";
                        break;
            ...
            string AllFields = "a.Id,a.NewsID,a.NewsType,a.SavePath,a.CommTF,a.datalib,a.FileName,a.FileEXName,a.isDelPoint,a.TitleColor,a.templet,a.TitleITF,a.TitleBTF,a.Author,a.DataLib,a.OrderID,a.NewsTitle,a.ishtml,a.Editor,a.Click,a.isConstr,a.ClassID,a.SpecialID,a.isLock,a.NewsProperty,a.CheckStat,a.URLaddress,b.UserName,c.ClassCName,c.SaveClassframe,c.SavePath as SavePath1";
            ...
            return DbHelper.ExecutePage(AllFields, Condition, IndexField, OrderFields, PageIndex, PageSize, out RecordCount, out PageCount, sqlParams);
        }
       ...
       /// <param name="NewsID">新闻的NewsID</param>
        public void DelNews(string NewsID)
        {
            ...
            sql.Add("delete from " + Pre + "News_URL where NewsID ='"+NewsID+"'");
            sql.Add("delete from " + Pre + "define_save where DsNewsID ='"+NewsID+"'");
            sql.Add("delete from " + Pre + "special_news where NewsID ='"+NewsID+"'");
            sql.Add("delete from " + Pre + "news_sub where NewsID ='"+NewsID+"'");
            sql.Add("delete from " + Pre + "news_unNews where ONewsID ='"+NewsID+"'");
            sql.Add("delete from " + Pre + "News where NewsID='" + NewsID + "'");
        ...
        {
            DbHelper.ExecuteNonQuery(CommandType.Text, "DELETE FROM " + Pre + "news_URL WHERE NewsID=@newsid", new SqlParameter("@newsid", NewsID));
        }
        /// <summary>
        /// 更新附件文件地址
        /// </summary>
        ...
        public void UpdateFileURL(string URLName, string DataLib, string FileURL, int OrderID, int ID)
        {
            ...
            DbHelper.ExecuteNonQuery(CommandType.Text, Sql, new SqlParameter("URLName", URLName), new SqlParameter("DataLib", DataLib), new SqlParameter("FileURL", FileURL), new SqlParameter("OrderID", OrderID), new SqlParameter("UrlID", ID));
        }
        /// <summary>
        /// 插入附件
        /// </summary>
        ...
        public void InsertFileURL(string URLName, string NewsID, string DataLib, string FileURL, int OrderID)
        {
            ...
            Sql += ") values (";
            Sql += "@URLName,@NewsID ,@DataLib ,@FileURL,getdate(),@OrderID)";
            DbHelper.ExecuteNonQuery(CommandType.Text, Sql, new SqlParameter("URLName", URLName), new SqlParameter("NewsID", NewsID), new SqlParameter("DataLib", DataLib), new SqlParameter("FileURL", FileURL), new SqlParameter("OrderID", OrderID));
        }
        /// <summary>
        /// 检查新闻标题
        /// </summary>
        ...
        /// <param name="uc"></param>
        /// <returns></returns>
        private SqlParameter[] insertNewsContentParameters(Foosun.Model.News uc)
        {
        ...
        public void InsertNewsContent(Foosun.Model.News uc)
        {
            ...
            Sql += ") values (";
            Sql += "@NewsID,@NewsType,@OrderID,@NewsTitle,@sNewsTitle,@TitleColor,@TitleITF,@TitleBTF,@CommLinkTF,@SubNewsTF,@URLaddress,@PicURL,@SPicURL,@ClassID,@SpecialID,@Author,@Souce,@Tags,@NewsProperty,@NewsPicTopline,@Templet,@Content,@vURL,@naviContent,@Click,@CreatTime,'" + DateTime.Now + "',@SavePath,@FileName,@FileEXName,@ContentPicTF,@ContentPicURL,@ContentPicSize,@CommTF,@DiscussTF,@TopNum,@VoteTF,@CheckStat,@isLock,@isRecyle,@SiteID,@DataLib,@DefineID,@isVoteTF,@Editor,@isHtml,@isDelPoint,@Gpoint,@iPoint,@GroupNumber,@Metakeywords,@Metadesc,0,@isFiles)";
            SqlParameter[] parm = insertNewsContentParameters(uc);
            DbHelper.ExecuteNonQuery(CommandType.Text, Sql, parm);
        ...
        {
            SqlParameter[] param = new SqlParameter[1];
            param[0] = new SqlParameter("@NewsID", SqlDbType.VarChar, 12);
            param[0].Value = NewsID;
