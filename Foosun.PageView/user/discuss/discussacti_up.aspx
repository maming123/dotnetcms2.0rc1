<%@ Page Language="C#" ContentType="text/html" ResponseEncoding="utf-8" AutoEventWireup="true" Inherits="user_discussacti_up" EnableEventValidation="true" Codebehind="discussacti_up.aspx.cs" %>
...
<table width="100%"  border="0" cellpadding="0" cellspacing="0" class="toptable">
    ...
    <td width="43%" class="list_link"  style="PADDING-LEFT: 14px" ><div style="text-align:right; margin-right:10px;">位置导航：<a href="../main.aspx" target="sys_main" class="list_link">首页</a><img alt="" src="../images/navidot.gif" border="0" /><a href="discussacti_list.aspx" class="menulist">讨论活动管理</a><img alt="" src="../images/navidot.gif" border="0" />修改活动</div></td>
        </tr>
</table>
...
<table width="98%" border="0" align="center" cellpadding="5" cellspacing="1" bgcolor="#FFFFFF" class="Tablist tab">  
  ...
  <tr class="TR_BG_list">
    ...
    <td class="list_link">
        <asp:RadioButtonList ID="ALabelList" runat="server" RepeatDirection="Horizontal"  RepeatLayout="Flow"
            Width="242px">
    ...
    <td class="list_link">
        <asp:TextBox ID="ActiveExpenseBox" runat="server" Width="346px"></asp:TextBox>&nbsp;
    ...
    <td class="list_link">
        <asp:TextBox ID="ContactmethodBox" runat="server" Width="348px"></asp:TextBox>&nbsp;
    ...
    <td class="list_link">
        <asp:TextBox ID="ActivePlanBox" runat="server" CssClass="form" TextMode="MultiLine" Height="76px" Width="348px"></asp:TextBox>&nbsp;
    ...
    <td class="list_link">
        &nbsp;&nbsp;
        <asp:Button ID="inBox" runat="server" Text="确 定" OnClick="inBox_Click" CssClass="from"/>
        &nbsp;&nbsp;&nbsp;&nbsp; &nbsp;<input type="reset" name="Submit3" value="重 置" class="from"></td>
  </tr>
</table>
