<%@ Page Language="C#" ContentType="text/html" AutoEventWireup="true" ValidateRequest="false" Inherits="user_Constr" Debug="true" CodeBehind="Constr.aspx.cs" %>
...
<div  class="main_big">
    ...
    <td width="43%" class="list_link"  style="PADDING-LEFT: 14px" ><div style="text-align:right; margin-right:10px;">位置导航：位置导航：<a href="../main.aspx" target="sys_main" class="list_link">首页</a><img alt="" src="../images/navidot.gif" border="0" /><a href="Constrlist.aspx" class="menulist">文章管理</a></div>
			</td>
		</tr>
	</table>
	...
	<table width="100%" border="0" align="center" cellpadding="5" cellspacing="1" bgcolor="#FFFFFF" class="Tablist tab">
		<tr class="TR_BG_list">
			...
			<td class="list_link" colspan="5">
				...
				<asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="Title" ErrorMessage="请输入文章标题"></asp:RequiredFieldValidator>
			</td>
		</tr>
		<tr class="TR_BG_list">
			<td class="list_link" style="text-align: right; width: 110px;">
				...
				<br />
				<br />
				<a href="javascript:;" onclick="javascript:selectFile('vURL','图片选择','user_file','500','350')">上传图片:</a><br />
				<%--<a href="javascript:;" onclick="selectFile('user_Edit',document.getElementById('picContentTF'),320,500);">上传视频</a>--%>
			</td>
			<td class="list_link" colspan="5" style="width: 750px; height: 250px; padding:10px;">
		...
		<tr class="TR_BG_list">
			...
			<td class="list_link" colspan="5" valign="top">
				<asp:TextBox ID="vURL" runat="server" MaxLength="200" Width="40%" CssClass="form"></asp:TextBox><img src="../images/s.gif" alt="选择视频" border="0" style="cursor: pointer;" onclick="javascript:selectFile('vURL','视频选择','user_file','500','350')" />&nbsp;<a href="javascript:void(0);" onclick="ivurl();" style="color: Blue;">把视频添加入编辑器中</a>
				<%--<asp:HiddenField runat="server" ID="vURL" />--%>
			</td>
		</tr>
		<tr class="TR_BG_list">
			<td class="list_link" style="text-align: right; width: 110px;">
			...
			<td class="list_link" colspan="5" valign="top">
              <div style="width:100%; float:left; margin-top:5px;">
				<div style="width:30%; float:left; line-height:20px;">
					<asp:RadioButtonList ID="inList1" runat="server" RepeatDirection="Horizontal" Width="192px" RepeatLayout="Flow">
               ...
               <div style="width:30%; float:left; line-height:20px; display:none;">
					投稿给管理员：
					<asp:RadioButtonList ID="fbList1" runat="server" RepeatDirection="Horizontal" RepeatLayout="Flow" Width="103px">
		...
		<tr class="TR_BG_list">
			...
			<td class="list_link" colspan="5">
				&nbsp;<asp:DropDownList ID="site" runat="server" Width="147px" CssClass="form">
				</asp:DropDownList>
		...
		<tr class="TR_BG_list" style="display:none">
			...
			<td class="list_link">
				<asp:TextBox ID="ClassCName" runat="server" Width="147px" ReadOnly="true"></asp:TextBox>&nbsp; &nbsp;<input class="form" type="button" value="选择栏目" onclick="javascript:selectFile('ClassName,ClassID','栏目选择','newsclass','400','300')" />
		...
		<tr class="TR_BG_list">
			...
			<td class="list_link" colspan="5" valign="top">
              <div style="width:100%; float:left; margin-top:5px;"">
				<div style="width:30%; float:left; line-height:20px;">
							<asp:RadioButtonList ID="Locking" runat="server" RepeatDirection="Horizontal" RepeatLayout="Flow" Width="93px">
                ...
                <div style="width:30%; float:left; line-height:20px;">
							推 荐：
							<asp:RadioButtonList ID="Recommendation" runat="server" RepeatDirection="Horizontal" RepeatLayout="Flow" Width="94px">
								<asp:ListItem Value="1">是</asp:ListItem>
								<asp:ListItem Selected="True" Value="0">否</asp:ListItem>
							</asp:RadioButtonList>
                   </div>
