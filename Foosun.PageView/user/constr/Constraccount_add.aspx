<%@ Page Language="C#" ContentType="text/html" ResponseEncoding="utf-8" AutoEventWireup="true" Inherits="user_Constraccount_add" Debug="true" Codebehind="Constraccount_add.aspx.cs" %>
...
<table width="100%"  border="0" cellpadding="0" cellspacing="0" class="toptable">
        ...
        <tr>
          ...
          <td width="43%" class="list_link"  style="PADDING-LEFT: 14px" ><div style="text-align:right; margin-right:10px;">位置导航：<a href="../main.aspx" target="sys_main" class="list_link">首页</a><img alt="" src="../images/navidot.gif" border="0" /><a href="Constrlist.aspx" class="menulist">稿件管理</a><img alt="" src="../images/navidot.gif" border="0" />添加账号</div></td>
        </tr>
</table>
...
<table width="98%" border="0" align="center" cellpadding="5" cellspacing="1"  class="Tablist tab">
    <tr class="TR_BG_list">
<td class="list_link" width="25%" align="right">        真实姓名：</td>
    <td class="list_link">
        ...
        <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ErrorMessage="真实姓名不能为空" ControlToValidate="RealNameBox"></asp:RequiredFieldValidator>
        </td>
    </tr>
    <tr class="TR_BG_list">
<td class="list_link" width="25%" align="right">        开户银行：</td>
    <td class="list_link">
    ...
    <tr class="TR_BG_list">
<td class="list_link" width="25%" align="right">        开户名：</td>
    <td class="list_link">
    ...
    <tr class="TR_BG_list">
<td class="list_link" width="25%" align="right">        银行账号：</td>
    <td class="list_link">
    ...
    <tr class="TR_BG_list">
<td class="list_link" width="25%" align="right">        卡号：</td>
    <td class="list_link">
   ...
   <tr class="TR_BG_list">
<td class="list_link" width="25%" align="right">        地址：</td>
  ...
  <tr class="TR_BG_list">
<td class="list_link" width="25%" align="right">        邮政编码：</td>
    <td class="list_link">
