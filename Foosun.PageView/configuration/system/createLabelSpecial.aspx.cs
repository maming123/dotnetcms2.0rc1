...
{
    public partial class createLabelSpecial : Foosun.PageBasic.ManagePage
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                style_class.InnerHtml = Common.Public.getxmlstylelist("styleContent2", _dirdumm + "/xml/cuslabeStyle/cstylespecial.xml");               
            }
        }
    }
}