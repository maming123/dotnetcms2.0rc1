<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="createLabelClass.aspx.cs" Inherits="Foosun.PageView.configuration.system.createLabelClass" %>
...
<form id="ListLabel" runat="server">
         <div class="newxiu_base">
           <table class="nxb_table">
             <tr>
               <td width="15%" align="right">栏目ID ：</td>
               <td>
                  <div class="neitab1">
                     <input type="text" id="ClassName" name="" value="" class="input6" /><input id="ClassId" type="hidden" />
                     <a href="javascript:selectFile('ClassName,ClassId','栏目列表','newsclass','400','300');"><img src="/CSS/imges/bgxiu_14.gif" align="middle" alt="" /></a>
