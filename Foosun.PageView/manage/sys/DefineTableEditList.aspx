<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DefineTableEditList.aspx.cs"
    Inherits="Foosun.PageView.manage.sys.DefineTableEditList" %>
        ...
        <div class="mian_cont">
            <div class="nwelie">
                <div class="lanlie_lie">
                    <div class="flie_lan">
                        <a href="DefineTableManage.aspx">分类管理</a>┋<a href="DefineTable.aspx">新增字段</a>┋<a
                            href="DefineTableManage.aspx?action=add">新增分类</a>
                    </div>
                    <div class="newxiu_base">
                        <table class="nxb_table">
                            <tr>
                                <td colspan="2">
                                    <font>添加/修改自定义字段信息</font>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td>
                                    <asp:DropDownList ID="ColumnsType" runat="server" class="select3">
                                    </asp:DropDownList>                                    
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td>
                                    <asp:TextBox onChange="javascript:GetPY1(this);" ID="DefName" runat="server" MaxLength="50"
                                        class="input8"></asp:TextBox><asp:RequiredFieldValidator ID="f_menuName" runat="server"
                                            ControlToValidate="DefName" Display="Dynamic" ErrorMessage="<span class='reshow'>(*)请填写字段中文名称,长度不能超过50个字符!</span>"></asp:RequiredFieldValidator>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    &nbsp;<asp:RegularExpressionValidator ID="RegularExpressionValidator1" runat="server"
                                        ErrorMessage="英文名称必须是英文或数字及下划线!" ControlToValidate="DefEname" Display="Dynamic"
                                        SetFocusOnError="True" ValidationExpression="^[a-zA-Z_0-9__]+$"></asp:RegularExpressionValidator>
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="DefEname"
