<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AdminGroupAdd.aspx.cs" Inherits="Foosun.PageView.manage.sys.AdminGroupAdd" %>
...
<div class="mian_wei">
   ...
   <div class="mian_wei_min">
      <div class="mian_wei_left"><h3>添加管理员组</h3></div>
      <div class="mian_wei_right">
          导航：<a href="javascript:openmain('../main.aspx')">首页</a>>><a href="AdminiGroupList.aspx">管理员组管理</a> >>添加管理员组
      </div>
   </div>
  ...
  <table class="nxb_table">
    <tr>
      <td width="20%" align="right">管理员组名称：</td>
      <td align="left"><input type="text" name="GroupName" maxlength="20" id="GroupName" class="input4" style="width:200px;" />
  ...
  <div class="nxb_submit">
    <input type="button" name="TJ" value="确 定" class="xsubmit1" onclick="javascript:Submit(this.form);" />
    <input type="reset" value="重 填" class="xsubmit1" onclick="javascript:listClear();" />
    <input id="News_List" name="News_List" type="hidden" />
    <input type="hidden" id="Site_List" name="Site_list" />
    <input type="hidden" id="Sp_List" name="Sp_list"/>
  </div>
  </div>
  </div>
  </div>
