<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PublishPage.aspx.cs" Inherits="Foosun.PageView.manage.publish.PublishPage" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head>
    <title>
        <%Response.Write(Foosun.Config.UIConfig.HeadTitle); %>单页发布</title>
    ...
    <script>
        ...
        function AjaxPublish() {
            ...
            var para = "";
            var classall = document.getElementById("pageall").checked;
            var newClass = document.getElementById("ListBox_singleness");
            var intvalue = "";
            if (classall != true) {
            ...
            para = "type=page&pageid=" + intvalue;
            if (para != "") {
                url += "&" + para;
            }
...
<body>
    ...
    <div class="mian_body">
        ...
        <div class="mian_cont">
            <div class="nwelie">
                <div class="jslie_lan">
                    <span>功能：</span><a href="PublishIndex.aspx">首页、新闻生成设置</a>┊<a href="PublishNewsClass.aspx">栏目生成设置</a>┊<a
                        href="PublishSpecial.aspx">专题生成设置</a>┊<a href="PublishPage.aspx">单页生成设置</a>
                </div>
                <div class="lanlie_lie">
                    <div class="newxiu_base">
                        <table class="nxb_table" id="TableSingle">
                            <tr>
                                <td width="15%" align="right">
                                    发布单页：
                                </td>
                                <td>
                                    <input type="checkbox" id="pageall" class="checkbox2" /><label for="pageall">发布所有单页</label>
                                    <br />
                                    <asp:ListBox ID="ListBox_singleness" Width="485px" runat="server" Rows="20" SelectionMode="Multiple"
