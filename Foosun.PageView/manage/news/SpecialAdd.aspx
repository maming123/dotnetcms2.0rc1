<%@ Page Language="C#" AutoEventWireup="true" Inherits="SpecialAdd" CodeBehind="SpecialAdd.aspx.cs" validateRequest="false" %>
            ...
            <div class="lanlie_lie">
                <div class="newxiu_base">
                    <table class="nxb_table">
                        <tr>
                            <td width="11%" align="right" class="navi_link" style="width: 13%">
                                专题中文名：
                            </td>
                            <td colspan="2" align="left">
                                <asp:TextBox ID="S_Cname" runat="server" class="input8" onChange="javascript:GetPY2(this);" MaxLength="50"></asp:TextBox>
                        ...
                        <tr>
                            ...
                            <td colspan="2" align="left">
                                <asp:TextBox ID="S_Ename" runat="server" onChange="javascript:GetPositionHtml();"
                                     MaxLength="50" class="input8"></asp:TextBox>
                        ...
                        <tr id="Tr_Pop" style="display: none;">
                            ...
                            <td colspan="2" align="left">
                              <div class="textdiv">
                                会员组<br />
                                <asp:DropDownList ID="S_UserGroup" runat="server"  class="select5" Height="100px"
                                    multiple="multiple">
                                </asp:DropDownList>
                                <p>
                                    设&nbsp;&nbsp;&nbsp;置
                        ...
                        <tr>
                            ...
                            <td colspan="2" align="left">
                                <asp:TextBox ID="S_DirRule" runat="server"  MaxLength="100" class="input8"></asp:TextBox>&nbsp;<img src="../imges/bgxiu_14.gif"  align="middle" style="cursor: pointer;" alt="选择规则" onclick="selectFile('S_DirRule','生成目录规则','rulesmallPramo',500,200);document.F_Speical.S_DirRule.focus();" />
                                <span class="helpstyle" style="color:#828282" title="点击显示帮助" onclick="Help('H_SpecialAdd_006',this)">
                                    帮助</span>
                                <asp:RequiredFieldValidator ID="RequiredFieldValidatorS_DirRule" runat="server" ErrorMessage="<span class=reshow>(*)请选择目录规则</spna>"
                                    ControlToValidate="S_DirRule" Display="Static"></asp:RequiredFieldValidator>
                            </td>
                        </tr>
                        <tr>
                            <td align="right" class="navi_link" style="width: 13%">
                            ...
                            <td colspan="2" align="left">
                                <asp:TextBox ID="S_FileRule" runat="server"  MaxLength="100" class="input8"></asp:TextBox>&nbsp;<img src="../imges/bgxiu_14.gif"  align="middle" style="cursor: pointer;" alt="选择规则" onclick="selectFile('S_FileRule','生成文件规则','rulePram',500,200);document.F_Speical.S_FileRule.focus();" />
                                <span class="helpstyle" style="color:#828282" title="点击显示帮助" onclick="Help('H_SpecialAdd_007',this)">
                                    帮助</span>
                                <asp:RequiredFieldValidator ID="RequiredFieldValidatorS_FileRule" runat="server"
                                    ErrorMessage="<span class=reshow>(*)请选择文件规则</spna>" ControlToValidate="S_FileRule"
                        ...
                        <tr>
                            ...
                            <td colspan="2" align="left">
                                ...
                                <img src="../imges/bgxiu_14.gif"  align="middle" style="cursor: pointer;" alt="选择路径" onclick="selectFile('S_SavePath','专题保存路径','path|html',500,500);document.F_Speical.S_SavePath.focus();" />
                                <span class="helpstyle" style="color:#828282" title="点击显示帮助" onclick="Help('H_SpecialAdd_009',this)">
                                    帮助</span>
                                <asp:RequiredFieldValidator ID="RequiredFieldValidatorS_SavePath" runat="server"
                                    ErrorMessage="<span class=reshow>(*)请选择专题保存路径</spna>" ControlToValidate="S_SavePath"
                                    Display="Static"></asp:RequiredFieldValidator>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td colspan="2" align="left">
                                <asp:TextBox ID="S_Pic" runat="server"  MaxLength="200" class="input8"></asp:TextBox>&nbsp;<img
                                    src="../imges/bgxiu_14.gif" style="cursor: pointer;" alt="选择图片" onclick="selectFile('S_Pic','专题导航图片','pic',500,500);document.F_Speical.S_Pic.focus();" />
                                <span class="helpstyle" style="color:#828282" title="点击显示帮助" onclick="Help('H_SpecialAdd_010',this)">
                                    帮助</span>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td colspan="2" align="left">
                              <div class="textdiv">
                                <asp:TextBox ID="S_Text" runat="server"  Width="360px" TextMode="MultiLine"
                                    Height="100px"></asp:TextBox>
                                <span class="helpstyle" style="color:#828282" title="点击显示帮助" onclick="Help('H_SpecialAdd_011',this)">
                                    帮助</span>
                               </div>
                            </td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td colspan="2" align="left">
                              <div class="textdiv">
                                <asp:TextBox ID="S_Page" runat="server"  TextMode="MultiLine" Width="360px"
                                    Height="100px"></asp:TextBox>
                                <span class="helpstyle" style="color:#828282" title="点击显示帮助" onclick="Help('H_SpecialAdd_013',this)">
                                    帮助</span>
                               </div>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td align="left">
                              <div class="textdiv">
                                <asp:RadioButtonList ID="S_Lock"  runat="server" class="rdblist" RepeatDirection="Horizontal" RepeatLayout="Flow">
                                    <asp:ListItem Value="1">是</asp:ListItem>
                                    <asp:ListItem Value="0" Selected="True">否</asp:ListItem>
                                </asp:RadioButtonList>
                                <span class="helpstyle" style="color:#828282" title="点击显示帮助" onclick="Help('H_SpecialAdd_014',this)">
                                    帮助</span>
                              </div>
...
<script language="javascript" type="text/javascript">
    ...
    function TEname_1() {
        if ($('#S_Ename').val() == '') {
            ...
            $('S_Page').val("<a href=\"/\" target=\"_blank\">首页</a> >> <a href=\"{#URL}\"> " + document.getElementById("S_Cname").value + "</a> >> 专题列表");
        }
    } 
